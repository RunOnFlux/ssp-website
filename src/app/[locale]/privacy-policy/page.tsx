...
export const metadata: Metadata = createMetadata({
  title: 'Privacy Policy - SSP Wallet Ecosystem',
  description:
    'Privacy Policy for the complete SSP Wallet ecosystem. Learn how we protect your privacy across our website, browser extension, mobile app, and relay service.',
  path: '/privacy-policy',
})
        ...
        <div className='prose prose-lg dark:prose-invert max-w-none'>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              This Privacy Policy ("Policy") describes how InFlux Technologies Limited, a UK company
              ("we," "us," or "our"), handles information in connection with the SSP Wallet
              ecosystem, including our websites (sspwallet.io and sspwallet.com), SSP Wallet browser
              extension, SSP Key mobile application, SSP Relay service, and related services
              (collectively, the "Services").
            </p>
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              SSP Wallet is designed with privacy-by-design principles. We are committed to
              minimizing data collection and ensuring user control over their cryptocurrency assets
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
                <strong>No Private Key Access:</strong> We never have access to, store, or transmit
                your private keys, seed phrases, or wallet passwords
              </li>
              <li>
                <strong>Local Storage Only:</strong> All sensitive wallet data is stored locally on
                your devices using AES-GCM encryption
              </li>
              <li>
                <strong>Minimal Data Collection:</strong> We collect only the minimum data necessary
                to facilitate secure device communication
              </li>
              <li>
                <strong>Temporary Data:</strong> Communication data is automatically deleted within
                15 minutes
              </li>
              <li>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              To enable secure 2-of-2 multisignature functionality between your browser wallet and
              mobile app, our SSP Relay service temporarily stores:
            </p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
                <strong>Synchronization Data:</strong> Public keys and extended public keys (xpubs)
                for device pairing (15-minute retention)
              </li>
              <li>
                <strong>Transaction Requests:</strong> Partially signed transaction data awaiting
                second signature (15-minute retention)
              </li>
              <li>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              <strong>Important:</strong> Analytics tracking is completely disabled by default and
              only activated with your explicit consent through our cookie banner.
            </p>
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              When you choose to use fiat on/off-ramp services, you will be redirected to Onramper,
              a third-party service. Your interaction with Onramper is subject to their privacy
              policy and terms of service. We share only:
            </p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              We use Firebase Cloud Messaging to send push notifications about pending transactions.
              This service stores device tokens but does not access message content.
            </p>
          </section>
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              ...
              <li>
                <strong>Device Fingerprint Encryption:</strong> Additional encryption layer using
              ...
              <li>
                <strong>Secure Transmission:</strong> All communications use HTTPS/WSS encryption
              </li>
              <li>
                <strong>Automatic Deletion:</strong> Temporary communication data is automatically
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              ...
              <li>
                <strong>Push Tokens:</strong> Stored until device uninstalls app or token refresh
              </li>
              <li>
                <strong>Web Server Logs:</strong> Retained for security purposes for a maximum of 30
                days
              </li>
              <li>
                <strong>Local Wallet Data:</strong> Under your complete control; can be deleted by
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
                <strong>Data Portability:</strong> Export your seed phrases and wallet data at any
                time
              </li>
              <li>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              <strong>Note:</strong> Due to blockchain immutability, transaction data recorded on
              public blockchains cannot be deleted.
            </p>
          </section>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              Our relay servers may be located in various jurisdictions. When you use SSP Wallet,
              minimal technical data (public keys, transaction requests) may be temporarily
              processed in these locations. All data remains encrypted and is automatically deleted
              within 15 minutes.
            </p>
          </section>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              knowingly collect information from children under 18. If you become aware that a child
