        ...
        <div className='prose prose-lg dark:prose-invert max-w-none'>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              uses cookies and similar technologies on our websites sspwallet.io and sspwallet.com
              ("Website"). This policy should be read alongside our Privacy Policy and Terms of
              Service.
            </p>
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              This policy covers only the Website. For information about data handling in SSP Wallet
              applications, please refer to our Privacy Policy and Terms of Service.
            </p>
          </section>
            ...
            <div className='space-y-6'>
              <div className='rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-700 dark:bg-green-900/20'>
                ...
                <ul className='list-disc space-y-1 pl-6 text-green-700 dark:text-green-300'>
                  ...
                  <li>
                    <strong>Security:</strong> Protection against cross-site request forgery (CSRF)
                  </li>
                  <li>
              ...
              <div className='rounded-lg border border-purple-200 bg-purple-50 p-4 dark:border-purple-700 dark:bg-purple-900/20'>
                ...
                <ul className='list-disc space-y-1 pl-6 text-purple-700 dark:text-purple-300'>
                  ...
                  <li>
                    <strong>Performance Metrics:</strong> Page load times and technical performance
                  </li>
                </ul>
                <p className='mt-2 text-sm text-purple-600 dark:text-purple-400'>
                  These cookies require your consent and can be disabled through our cookie banner.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className='mb-8'>
            ...
            <div className='mb-4 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-700 dark:bg-blue-900/20'>
              <p className='text-blue-800 dark:text-blue-200'>
                <strong>Privacy-First Approach:</strong> Google Analytics is completely disabled by
                default. The analytics script only loads after you explicitly accept analytics
                cookies through our consent banner.
              </p>
            </div>
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              When you consent to analytics cookies, Google Analytics collects information such as:
            </p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
                <strong>Chrome:</strong> Settings → Privacy and Security → Site Settings → Cookies
              </li>
              <li>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              Our Website may include content or links to third-party services that may set their
              own cookies:
            </p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              technology, or legal requirements. Material changes will be communicated through our
              Website and you may be asked to provide fresh consent.
            </p>
          </section>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              For questions about this Cookie Policy or to exercise your rights regarding cookies,
              please contact:
            </p>
