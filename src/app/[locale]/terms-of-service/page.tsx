...
export const metadata: Metadata = createMetadata({
  title: 'Terms of Service - SSP Wallet Ecosystem',
  description:
    'Terms of Service for the complete SSP Wallet ecosystem including website, browser extension, mobile app, and relay service.',
        ...
        <div className='prose prose-lg dark:prose-invert max-w-none'>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              United Kingdom ("Company," "we," "us," or "our"), governing your use of the entire SSP
              Wallet ecosystem, including but not limited to:
            </p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
                <strong>SSP Wallet Websites:</strong> sspwallet.io, sspwallet.com, and related web
                properties
              </li>
              <li>
                <strong>SSP Wallet Browser Extension:</strong> Chrome, Firefox, and other browser
                wallet applications
              </li>
              <li>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              multisignature system requiring two separate devices (browser and mobile) to authorize
              transactions. Key characteristics include:
            </p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
              ...
              <li>
                <strong>Open Source:</strong> All software is licensed under AGPL-3.0 and publicly
                auditable
              </li>
              <li>
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
                <strong>BIP48 Key Derivation:</strong> Industry-standard hierarchical deterministic
                key generation
              </li>
              <li>
              ...
              <li>
                <strong>Temporary Relay Storage:</strong> Communication data automatically deleted
                within 15 minutes
              </li>
            </ul>
          </section>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              As a self-custody wallet user, you acknowledge and accept complete responsibility for:
            </p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
                <strong>Seed Phrase Security:</strong> Securing, backing up, and never sharing your
                24-word seed phrases for both wallet and key
              </li>
              <li>
              ...
              <li>
                <strong>Device Security:</strong> Protecting both browser and mobile devices from
                unauthorized access, malware, and physical theft
              </li>
              <li>
              ...
              <li>
                <strong>Backup Maintenance:</strong> Creating and securely storing multiple backups
                of your seed phrases
              </li>
              <li>
                <strong>Loss Prevention:</strong> Understanding that lost seed phrases or passwords
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              ...
              <li>Using the Services in jurisdictions where cryptocurrency use is prohibited</li>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              third-party services and accept no liability for any losses arising from their use,
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              "SSP Wallet," "SSP Key," related logos, and branding elements are trademarks of InFlux
              Technologies Limited. The open source license does not grant rights to use our
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              SSP Wallet is a self-custody cryptocurrency wallet. You are entirely responsible for
              managing and securing your seed phrases, wallet addresses, and digital assets. We do
              not store, manage, or have access to your seed phrases, passwords, or private keys.
              Any loss, compromise, or unauthorized access to your wallet is solely your
              responsibility.
            </p>
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              <strong>Critical Warning:</strong> If you lose your seed phrase or password, we cannot
              assist in recovering your assets. It is critical that you securely store your seed
              phrase in a safe and offline location.
            </p>
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
                <strong>Cryptocurrency swaps and exchanges</strong> (including QuickSwap and other
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              These services are operated by independent providers. We do not control, endorse, or
              guarantee their availability, functionality, or security. When using third-party
              services, their respective terms and conditions apply. SSP Wallet is not liable for
              any loss, errors, or security breaches resulting from these services.
            </p>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              SSP Wallet integrates QuickSwap and other decentralized exchange (DEX) solutions to
              allow users to swap cryptocurrencies. However, all swaps are executed on third-party
              platforms, and SSP Wallet does not facilitate or process the transactions directly.
            </p>
            <div className='mb-4 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-700 dark:bg-amber-900/20'>
              ...
              <ul className='list-disc space-y-2 pl-6 text-amber-800 dark:text-amber-200'>
                <li>
                  Transactions occur on the blockchain and are <strong>irreversible</strong> once
                  executed
                </li>
                <li>
                ...
                <li>
                  <strong>Floating rates apply:</strong> The final amount received may differ from
                  the initially displayed estimate due to market volatility
                </li>
                <li>Network fees (gas fees) apply and vary depending on blockchain congestion</li>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              SSP Wallet provides access to third-party cryptocurrency onramp and offramp services
              through integration with Onramper and other providers. These services are provided by
              independent financial institutions, payment processors, and cryptocurrency exchanges.
            </p>
            ...
            <ul className='list-disc space-y-1 pl-6 text-gray-600 dark:text-gray-400'>
              ...
              <li>Fees may apply and vary based on market conditions and third-party policies</li>
            </ul>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              Users should verify important transactions using blockchain explorers or other trusted
              sources.
            </p>
          </section>
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              ...
              <li>
                <strong>Inaccuracies in displayed balances or transaction statuses</strong> caused
                by network congestion, API errors, or service delays
              </li>
              <li>
            ...
            <div className='mb-4 rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-700 dark:bg-red-900/20'>
              <p className='text-red-800 dark:text-red-200'>
                <strong>Critical Warning:</strong> Users must double-check all transaction details
                before confirming any transaction. Once a cryptocurrency transaction is broadcast to
                the blockchain, it is <strong>irreversible</strong> and cannot be undone under any
                circumstances.
              </p>
            </div>
          </section>
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
                <strong>No technical support:</strong> SSP Wallet does not provide technical support
                for third-party services
              </li>
              <li>
                <strong>Direct contact required:</strong> If you encounter issues with integrated
                services, you must contact the respective service provider for assistance
              </li>
              <li>
                <strong>No dispute resolution:</strong> We are not responsible for troubleshooting
                or dispute resolution with third-party providers
              </li>
              <li>
                <strong>Service availability:</strong> Third-party services may become unavailable,
                discontinued, or change their terms without notice
              </li>
              <li>
                <strong>Data handling:</strong> Third-party services may collect data in accordance
                with their own privacy policies
              </li>
            </ul>
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              You are responsible for reviewing the privacy terms and conditions of any third-party
              service you use through SSP Wallet.
            </p>
          </section>
          ...
          <section className='mb-8'>
            ...
            <div className='mb-6 rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-700 dark:bg-red-900/20'>
              ...
              <p className='text-red-800 dark:text-red-200'>
                Cryptocurrency involves significant financial risk. Only use funds you can afford to
                lose entirely. Past performance does not guarantee future results. We provide
                software tools, not investment advice.
              </p>
            </div>
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              ...
              <li>
                <strong>Regulatory Risk:</strong> Laws may change affecting cryptocurrency legality
                or taxation
              </li>
              <li>
                <strong>Technical Risk:</strong> Software bugs, network forks, or protocol changes
                may cause losses
              </li>
              <li>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              To protect your digital assets and maintain account security, we strongly recommend
            ...
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              ...
              <li>
                <strong>Be cautious of phishing attempts and scams</strong> - always verify URLs and
                never enter your seed phrase on suspicious websites
              </li>
              <li>
                <strong>Keep your wallet software updated</strong> to the latest version to benefit
              ...
              <li>
                <strong>Be aware of social engineering attacks</strong> - we will never ask for your
                seed phrase or private keys
              </li>
            </ul>
            <div className='mb-4 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-700 dark:bg-amber-900/20'>
              <p className='text-amber-800 dark:text-amber-200'>
                <strong>Important:</strong> SSP Wallet is not responsible for losses resulting from
                compromised seed phrases, phishing attacks, user negligence, or failure to follow
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              Users are entirely responsible for ensuring that their use of SSP Wallet complies with
              all applicable laws and regulations in their jurisdiction. This includes but is not
              limited to:
            </p>
            <ul className='list-disc space-y-1 pl-6 text-gray-600 dark:text-gray-400'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              We do not guarantee that our services are legal or available in all locations. Users
              in restricted jurisdictions use the Services at their own risk.
            </p>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              You are solely responsible for determining and fulfilling any tax obligations arising
              from cryptocurrency transactions. This includes:
            </p>
            <ul className='list-disc space-y-1 pl-6 text-gray-600 dark:text-gray-400'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              investment advice. We do not provide market predictions, financial planning services,
              or investment recommendations. Consult with qualified professionals regarding your
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              SSP Wallet and all associated services are provided "as-is" and "as-available" without
              warranties of any kind, express, implied, or statutory. We specifically disclaim and
              do not guarantee:
            </p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
              <li>
              ...
              <li>
                <strong>Security or uninterrupted operation</strong> of our platform or third-party
                services
              </li>
              <li>
              ...
              <li>
                <strong>Availability of third-party services</strong> including swaps, onramps, or
                dApp integrations
              </li>
              <li>
              ...
              <li>
                <strong>Protection against</strong> market volatility, slippage, or price movements
              </li>
            </ul>
          </section>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              PARTICULAR PURPOSE, NON-INFRINGEMENT, UNINTERRUPTED OPERATION, SECURITY, ACCURACY, OR
              PROTECTION AGAINST LOSS OF CRYPTOCURRENCY OR DIGITAL ASSETS.
            </p>
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, INFLUX TECHNOLOGIES LIMITED, ITS DIRECTORS,
              OFFICERS, EMPLOYEES, AGENTS, CONTRACTORS, AND AFFILIATES SHALL HAVE ABSOLUTELY NO
              LIABILITY WHATSOEVER FOR ANY DAMAGES, LOSSES, CLAIMS, OR HARM OF ANY KIND, INCLUDING
              BUT NOT LIMITED TO:
            </p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              INCLUDING CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY, OR OTHERWISE, AND EVEN IF WE
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              PERMITTED BY APPLICABLE LAW, INFLUX TECHNOLOGIES LIMITED AND ITS AFFILIATES SHALL HAVE
              NO LIABILITY WHATSOEVER FOR ANY CLAIMS, DAMAGES, LOSSES, OR HARM ARISING FROM OR
              RELATED TO THE SERVICES. IN JURISDICTIONS WHERE LIABILITY CANNOT BE COMPLETELY
              EXCLUDED, OUR TOTAL LIABILITY SHALL BE LIMITED TO THE MINIMUM AMOUNT PERMITTED BY LAW.
            </p>
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              YOU ACKNOWLEDGE AND AGREE THAT YOU USE THE SERVICES ENTIRELY AT YOUR OWN RISK AND THAT
              WE BEAR NO RESPONSIBILITY FOR ANY CONSEQUENCES OF YOUR USE.
            </p>
          </section>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              You agree to indemnify, defend, and hold harmless InFlux Technologies Limited and its
              officers, directors, employees, and affiliates from and against any claims, damages,
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              Any disputes arising from these Terms or your use of the Services shall be subject to
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              any time, with or without notice. However, as open source software, you may continue
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              ceasing to access our websites. Your locally stored wallet data will remain under your
              control.
            </p>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>Upon termination of your use:</p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              The Services are not intended for use by individuals under 18 years of age. By using
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              requirements, or business practices. Material changes will be communicated through:
            </p>
            <ul className='list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400'>
          ...
          <section className='mb-8'>
            ...
            <p className='mb-4 text-gray-600 dark:text-gray-400'>
              ...
              and Cookie Policy, constitute the entire agreement between you and InFlux Technologies
              Limited regarding the Services.
            </p>
          </section>
          ...
          <div className='mt-12 rounded-lg border border-blue-200 bg-blue-50 p-6 dark:border-blue-700 dark:bg-blue-900/20'>
            ...
            <ul className='list-disc space-y-2 pl-6 text-blue-800 dark:text-blue-200'>
              <li>
                <strong>Self-Custody:</strong> You control your keys and bear all responsibility for
                security
              </li>
              <li>
                <strong>Open Source:</strong> Software is AGPL-3.0 licensed and publicly auditable
              </li>
              <li>
                <strong>No Warranties:</strong> Services provided "as is" without guarantees
              </li>
              <li>
                <strong>No Liability:</strong> We accept no liability for any losses, damages, or
