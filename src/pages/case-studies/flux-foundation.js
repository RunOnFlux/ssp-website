...
export default function FluxFoundationCaseStudy() {
  const [heroRef, heroInView] = useInView({ threshold: 0.3, triggerOnce: true })

  return (
    <>
      <Head>
        <title>Case Study: Flux Foundation — Self-Custody Treasury with SSP Enterprise</title>
        <meta
          name='description'
          content='How the Flux Foundation moved from scattered multisig and custom scripts to SSP Enterprise — securing the Fusion bridge and Foundation treasury with M-of-N vaults across every chain they use.'
        />

        <meta property='og:title' content='Case Study: Flux Foundation × SSP Enterprise' />
        <meta
          property='og:description'
          content='Self-custody treasury and Fusion bridge multisig across Bitcoin, Ethereum, Flux, and EVM L2s. No custodian. No MPC. No black box.'
        />
        <meta property='og:url' content='https://sspwallet.io/case-studies/flux-foundation' />
        <meta property='og:image' content='https://sspwallet.io/og-image.png' />
        <meta property='og:image:width' content='1200' />
        <meta property='og:image:height' content='630' />

        <meta name='twitter:card' content='summary_large_image' />
        <meta name='twitter:title' content='Case Study: Flux Foundation × SSP Enterprise' />
        <meta
          name='twitter:description'
          content='Self-custody treasury and Fusion bridge multisig across Bitcoin, Ethereum, Flux, and EVM L2s.'
        />
        <meta name='twitter:image' content='https://sspwallet.io/og-image.png' />

        <link rel='canonical' href='https://sspwallet.io/case-studies/flux-foundation' />
      </Head>
